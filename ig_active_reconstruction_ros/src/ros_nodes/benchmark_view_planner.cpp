...
/*! Implements a ROS node holding a BenchmarkViewPlanner, combined with a simple command line user interface.
 */
int main(int argc, char **argv)
{
  ...
  iar::BenchmarkViewPlanner::Config bvp_config;
  ...
  // ...................................................................................................................
  boost::shared_ptr<iar::robot::RosClientRL> robot_comm = boost::make_shared<iar::robot::RosClientRL>(nh);
...
//   utility_calculator->setRobotCommUnit(robot_comm);
  ...
  {    
    while(keepReading)
    {
      iar::BenchmarkViewPlanner::Status status = view_planner.status();
      
      switch(status)
      {
	case iar::BenchmarkViewPlanner::Status::UNINITIALIZED:
	  ROS_INFO_STREAM("BenchmarkViewPlanner::Status::UNINITIALIZED");
	  break;
	case iar::BenchmarkViewPlanner::Status::IDLE:
	  ROS_INFO_STREAM("BenchmarkViewPlanner::Status::IDLE");
	  break;
	case iar::BenchmarkViewPlanner::Status::PAUSED:
	  ROS_INFO_STREAM("BenchmarkViewPlanner::Status::PAUSED");
	  break;
	case iar::BenchmarkViewPlanner::Status::DEMANDING_NEW_DATA:
	  ROS_INFO_STREAM("BenchmarkViewPlanner::Status::DEMANDING_NEW_DATA");
	  break;
	case iar::BenchmarkViewPlanner::Status::DEMANDING_VIEWSPACE:
	  ROS_INFO_STREAM("BenchmarkViewPlanner::Status::DEMANDING_VIEWSPACE");
	  break;
	case iar::BenchmarkViewPlanner::Status::NBV_CALCULATIONS:
	  ROS_INFO_STREAM("BenchmarkViewPlanner::Status::NBV_CALCULATIONS");
	  break;
	case iar::BenchmarkViewPlanner::Status::DEMANDING_MOVE:
	  ROS_INFO_STREAM("BenchmarkViewPlanner::Status::DEMANDING_MOVE");
	  break;
      };
