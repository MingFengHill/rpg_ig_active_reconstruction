...
namespace ig_active_reconstruction
{
  ...
  public:
     ...
     */
    virtual void setRobotCommUnit( boost::shared_ptr<robot::RosClientRL> robot_comm_unit );
  ...
  protected:
    ...
    boost::shared_ptr<robot::RosClientRL> robot_comm_unit_; //! Robot communication interface with which the view planner corresponds.
